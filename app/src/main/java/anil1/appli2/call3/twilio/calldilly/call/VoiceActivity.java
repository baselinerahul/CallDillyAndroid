package anil1.appli2.call3.twilio.calldilly.call;
...
public class VoiceActivity extends AppCompatActivity {
    ...
    private static String identity = "raj";
    /*
     ...
     */
    private static final String TWILIO_ACCESS_TOKEN_SERVER_URL = "https://calldilly.herokuapp.com/accessToken.php";
        ...
        Ion.with(this).load(TWILIO_ACCESS_TOKEN_SERVER_URL + "?identity=" + identity).asString().setCallback(new FutureCallback<String>() {
            ...
            public void onCompleted(Exception e, String accessToken) {
                if (e == null) {
                    ...
                    VoiceActivity.this.accessToken = accessToken.trim();
